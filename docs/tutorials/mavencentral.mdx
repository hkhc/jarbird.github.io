...
com/hkhc/jarbird-samples/tree/master/mavencentral).
...
Refer to Sonatype [page](https://central.sonatype.org/pages/requirements.html#sufficient-metadata) 
for detail requirements of POM to publish component to Maven Central.
